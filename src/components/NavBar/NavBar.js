  ...
  <ul className="navbar-nav">
    <li className="logo">
      <a href="/dashboard" className="nav-link">
        <span className="link-text logo-text"><img style={{width: '50px'}} src="https://cdn.gencraft.com/prod/user/03cd3d83-07a0-45da-97d8-689a8116bf94/d768013c-3e22-4cc0-866a-7c89154416dd/images/image0_0.jpg?Expires=1695568551&Signature=AvTENii2JO3viIQhstzDRHxWIKcg8cb7CMpdU5aJBKioKCzRKdyrY~12BlahHTmwus-NVgSljO5SvjZiGWWO6oyQp~slZflb0krKzaARzeOMOiPzfnMJ~7veZTXuGRcgu-WPueEIFNyEG6ADjkyhHBa4mKKtiCZJEeSbsBaTymSQ~HoWIVJJsCaRWdKOT0DmAe8vfyRH1tm7nvLhDv62glTJ7FZsZ5H-4Cr~4ZYA4T9Nk2F5Mf7hO~Xhc6nLvOv6DVPTZjITHyTz1-RO4PlaJre4aM3kc-fgvbGRmVP91PfcIFQkYQe8NxRGNuR-ANW3iHjua4LBHJqwakKVfcIyeg__&Key-Pair-Id=K3RDDB1TZ8BHT8" alt="arc-invoice" /></span>
